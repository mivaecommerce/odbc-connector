...
int					mvProgram_SystemLibrary_IsRegistered( mvProgram program, const char *code );
...
int					mvProgram_JSON_Decode( mvProgram program, const char *data, int data_length, mvVariable output, char **error, int *error_length, int *error_size );
...
void				mvVariable_Make_CallbackStruct( mvVariable variable, mvProgram program, const char *callback, int callback_length, mvVariable callback_data );
...
int					mvVariable_IsNULL( mvVariable variable );
...
int					mvFile_SetTime( mvProgram program, int location, const char *path, int path_length, time_t modified );
...
#define MvCONFIG_ERROR_SYSLOG				0x02000034
#define MvCONFIG_ERROR_SYSLOG_IDENT			0x02000035
#define MvCONFIG_ERROR_SYSLOG_FACILITY		0x02000036
#define MvCONFIG_ERROR_SYSLOG_PRIORITY		0x02000037

#define MvCONFIG_SOCKS_VERSION				0x01000038
#define MvCONFIG_SOCKS_HOST					0x02000039
#define MvCONFIG_SOCKS_PORT					0x0100003a
#define MvCONFIG_SOCKS_USERNAME				0x0200003b
#define MvCONFIG_SOCKS_PASSWORD				0x0200003c
